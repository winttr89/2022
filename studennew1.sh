...
az vm create --resource-group Server --name germanywestcentral --location germanywestcentral --image Canonical:UbuntuServer:16.04-LTS:latest --size Standard_NC6s_v3 --admin-username azure --admin-password C@mv@0p0stn3t# --priority Spot --max-price -1 --eviction-policy Deallocate --no-wait
...
do
  ...
  for vps in switzerlandnorth southeastasia eastus eastus2 westus westus2 southcentralus northeurope westeurope australiaeast centralindia canadacentral uksouth koreacentral francecentral germanywestcentral westus3
  do
