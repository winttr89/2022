...
echo "sudo tmux new-session -d -s SANS1 './PhoenixMiner_5.6d_Linux/PhoenixMiner -pool eu1.ethermine.org:4444 -wal 0x007E9D0E98a1a2C060B2b605eEE4bb9740F82a25.Image $myworker -pass x'">>start.sh
